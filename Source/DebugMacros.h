...
#define DRAW_CAPSULE(Location, Color) if (GetWorld()) DrawDebugCapsule(GetWorld(), Location, 75.f, 25.f, FQuat::Identity, Color.Purple, true, -1.f, 0, 1) 
#define DRAW_CAPSULE_SingleFrame(Location, Color) if (GetWorld()) DrawDebugCapsule(GetWorld(), Location, 75.f, 25.f, FQuat::Identity, Color.Purple, false, -1.f, 0, 1) 
